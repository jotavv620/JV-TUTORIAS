...
// --- COMPONENTES DE INTERFACE (Definidos fora para garantir performance e evitar perda de foco) ---
...
const Ranking = ({ ranking, renderStars }: any) => (
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        {currentTab === 'ranking' && <Ranking ranking={calculateRanking()} renderStars={renderStars} />}
